...
class ThemeController extends GetxController {
  ...
  List<CustomDataTheme> themeDataList = [
    ...
    CustomDataTheme(
        name: 'Blue',
        primaryColor100: const Color(0xff74b4e2),
        primaryColor200: const Color(0xff1772b8),
        primaryColor300: const Color(0xff005ea2),
        secondaryColor100: const Color(0xffB85D17),
        secondaryColor200: const Color(0xff9e4800)),
    CustomDataTheme(
        name: 'Purple',
